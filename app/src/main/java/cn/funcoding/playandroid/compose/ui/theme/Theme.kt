package cn.funcoding.playandroid.compose.ui.theme
...
private val LightColorPalette = PlayAndroidColors(
    brand = Shadow5,
...
private val DarkColorPalette = PlayAndroidColors(
    brand = Shadow1,
...
fun PlayAndroidTheme(
    ...
    ProvidePlayAndroidColors(colors) {
        MaterialTheme(
...
object PlayAndroidTheme {
    val colors: PlayAndroidColors
        @Composable
        get() = LocalPlayAndroidColors.current
}

/**
 * PlayAndroid custom Color Palette
 */
@Stable
class PlayAndroidColors(
    ...
    fun update(other: PlayAndroidColors) {
    ...
    fun copy(): PlayAndroidColors = PlayAndroidColors(
...
@Composable
fun ProvidePlayAndroidColors(
    colors: PlayAndroidColors,
    content: @Composable () -> Unit
) {
    ...
    CompositionLocalProvider(LocalPlayAndroidColors provides colorPalette, content = content)
}

private val LocalPlayAndroidColors = staticCompositionLocalOf<PlayAndroidColors> {
    error("No PlayAndroidColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [PlayAndroidTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
